...
public:
	...
	//Direct assignment
    friend long long BigInttoInt32(BigInt& b){
        long long num=0;
        for(int i=Lenght(b)-1;i>=0;i--){
            num=num*10+((int)b.digits[i]);
        }
        return num;
    }
...
int main()
{
    ...
    cin>>tmp;
    b=BigInt(tmp);
    long long num1=BigInttoInt32(a);
    b=b%a;
    long long num2=BigInttoInt32(b);
